...
from worlds.graphworlds.graphworld6 import GraphWorld6_w2

# Create GraphWorld2 instance
world = GraphWorld6_w2()
world.generate_min_action_transformation_matrix()
world.draw_graph()

# Create and generate global transformation algebra
global_algebra = TransformationAlgebra("graphworld6_global")
...
initial_state = (1,)
local_algebra = TransformationAlgebra("graphworld6_local")
