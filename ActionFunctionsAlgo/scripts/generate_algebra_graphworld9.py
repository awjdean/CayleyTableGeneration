...
from worlds.graphworlds.graphworld9 import GraphWorld9

# Create GraphWorld9 instance
world = GraphWorld9()
world.generate_min_action_transformation_matrix()
world.draw_graph(True)

# Create and generate global transformation algebra
global_algebra = TransformationAlgebra("graphworld9_global")
...
initial_state = (1,)
local_algebra = TransformationAlgebra("graphworld9_local")
