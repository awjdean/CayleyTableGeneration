...
from worlds.graphworlds.graphworld5 import GraphWorld5
...
global_algebra = TransformationAlgebra("graphworld5_global")
...
initial_state = (0,)
local_algebra = TransformationAlgebra("graphworld5_local")
