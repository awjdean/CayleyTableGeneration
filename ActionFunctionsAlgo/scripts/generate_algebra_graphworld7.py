...
from worlds.graphworlds.graphworld7 import GraphWorld7_w_minus_1

# Create GraphWorld7 instance
world = GraphWorld7_w_minus_1()
world.generate_min_action_transformation_matrix()
world.draw_graph()

# Create and generate global transformation algebra
global_algebra = TransformationAlgebra("graphworld7_global")
...
initial_state = (-2,)
local_algebra = TransformationAlgebra("graphworld7_local")
