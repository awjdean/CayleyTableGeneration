...
from transformation_algebra.comparing_algebras.enhance_equiv_classes import (
    compare_algebra_equiv_classes_elements,
...
def main():
    ...
    # Compare the two relabeled algebras
    print("\nComparing the two relabeled algebras:")
    compare_algebra_equiv_classes_elements(relabeled_algebra1, relabeled_algebra2)
    ...
    print(f"\nFinal equivalence classes for {relabeled_algebra1.name}:")
    print(relabeled_algebra1.equiv_classes)
    print(f"\nFinal equivalence classes for {relabeled_algebra2.name}:")
    print(relabeled_algebra2.equiv_classes)

    # Compare the relabeled algebras in detail
    print("\nComparing relabeled algebras in detail...")
    are_same = compare_algebras(relabeled_algebra1.name, relabeled_algebra2.name)
