...
cayley_table.generate_cayley_table(**params)
...
for e in cayley_table.cayley_table_actions.index:
    for a in cayley_table.cayley_table_actions.index:
        ...
        left_outcome_state = cayley_table.find_outcome_cayley(left_action=e, right_action=a, return_state_outcome=True)

        # Find the outcome of the RHS of the left identity equation.
        right_outcome_state = cayley_table.find_outcome_cayley(left_action=a, return_state_outcome=True)
...
for e in cayley_table.cayley_table_actions.index:
    for a in cayley_table.cayley_table_actions.index:
        ...
        left_outcome_state = cayley_table.find_outcome_cayley(left_action=a, right_action=e, return_state_outcome=True)
