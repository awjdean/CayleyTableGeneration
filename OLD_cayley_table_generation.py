...
class CayleyTable:
    ...
    def generate_cayley_table(cayley_table, **kwargs):
        """
        ...
        :return:
        """
        if (cayley_table.cayley_table_actions is not None) or (cayley_table.cayley_table_states is not None):
            raise Exception('Cayley table already generated. World used: {0}'.format(cayley_table._cayley_table_parameters))
        ...
        cayley_table._cayley_table_parameters = parameters
        ...
        ################################################################################################################
        # TODO: pandas --> dict.
        cayley_table.cayley_table_states = pandas.DataFrame(columns=copy.deepcopy(_minimum_actions),
        ...
        cayley_table.ecs, cayley_table.cayley_table_states = relabel_equivalence_classes(equivalence_classes=cayley_table.ecs,
                                                                                         cayley_table_states=cayley_table.cayley_table_states)

        # Create and fill action Cayley table.
        cayley_table.cayley_table_actions, cayley_table.ecs = generate_action_cayley_table(equivalence_classes=cayley_table.ecs,
                                                                                           cayley_table_states=cayley_table.cayley_table_states,
                                                                                           world=_world)
